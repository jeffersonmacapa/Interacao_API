        ...
        <div class="container p-2" >
            <form method="POST" action="">
                ...
                if (isset($_POST['salvar'])):
                    ...
                    $sql = 'INSERT INTO tbl_clientes (nome,endereco,iddobairro)';
                    $sql .= 'VALUES (:nome, :endereco,:bairro)';
                    ...
                    try {
                        ...
                        $inserir->bindValue(':bairro', $bairro, PDO::PARAM_STR);
                    ...
                    <div class="p-3 bg-info bg-opacity-10 border border-info border-start-0 rounded-end">
                        ...
                        <div class="input-group input-group-lg">
                            <select class="form-select form-select-lg mb-3" 
                                ...
                                <?PHP
                                $Buscabairros = $pdo->prepare("SELECT * FROM tbl_bairros order by nome");
                                $Buscabairros->execute();
                                $Linha = $Buscabairros->fetchALL(PDO::FETCH_ASSOC);
                ...
                <a href='exibir.php'>
                    <button type="button" class="btn btn-primary">Exibir Cadastro de clientes</button></a>  
                <a href='cadastrobairro.php'>
                    <button type="button" class="btn btn-primary">Cadastrar Bairros</button></a>  
                <a href='cadastrodeproduto.php'>
                    <button type="button" class="btn btn-primary">Cadastrar Produtos</button></a>  
                <a href='entradaebaixa.php'>
                    <button type="button" class="btn btn-primary">Entrada e saida de inssumos</button></a>  
            </div>
        </div>
