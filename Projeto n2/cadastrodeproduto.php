        ...
        <div class="container p-2" >
            <form method="POST" action="">
                ...
                if (isset($_POST['salvar'])):
                    ...
                    echo("Produto: " . $Descricao . " salvo com sucesso!!!<br>");
             

                    $sql = 'INSERT INTO tbl_produtos (descricao, estoque)';
                    $sql .= 'VALUES (:descricao, :estoque)';
                    ...
                    ?>           
                    <button onclick= "window.location.href = 'cadastrodeprodutos.php';">
                    ...
                    <div class="p-3 bg-info bg-opacity-10 border border-info border-start-0 rounded-end">
                        <div class="input-group input-group-lg">
                            <span class="input-group-text" id="inputGroup-sizing-lg">Descrição do produto</span>
                            <input type="text" class="form-control" aria-label="Sizing example input" 
                                   aria-describedby="inputGroup-sizing-lg" name="descricao" 
                                   placeholder="Descrição do produto" >
                        </div>
                        <br>                     
                        <div class="input-group input-group-lg">
                            <span class="input-group-text" id="inputGroup-sizing-lg">Estoque</span>
                            <input type="text" class="form-control" aria-label="Sizing example input" 
            ...
            <a href='listarprodutos.php'>
                    <button type="button" class="btn btn-primary">Exibir Cadastro</button></a>              
            <a href='index.php'>
                    <button type="button" class="btn btn-primary">Cadastrar CLientes</button></a>  
            <a href='cadastrobairro.php'>
                    <button type="button" class="btn btn-primary">Cadastrar Bairros</button></a>  
